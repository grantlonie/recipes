export const inputClassName =
  'w-full rounded-xl border border-orange-200 bg-white px-3 py-2 outline-none ring-orange-500 focus:ring-2 dark:border-stone-600 dark:bg-stone-900 dark:text-stone-100 dark:placeholder:text-stone-400'

export const cardClassName =
  'rounded-3xl bg-white p-6 shadow-sm ring-1 ring-orange-100 dark:bg-stone-800 dark:ring-stone-700'
